...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Book Updater') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('books.update',$book->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="auther" type="text" class="form-control{{ $errors->has('auther') ? ' is-invalid' : '' }}" name="auther" value="{{ $book->auther }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="category_name" type="text" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="category_name" value="{{ $book->category_name }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="impressions" type="text" class="form-control{{ $errors->has('impressions') ? ' is-invalid' : '' }}" name="impressions" value="{{ $book->impressions }}" required autofocus>
